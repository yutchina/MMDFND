...
3. **Weibo Dataset**: For the Weibo dataset, we adhere to the work from [(Wang et al.， 2022)](https://github.com/yaqingwang/EANN-KDD18) and provide data including domain labels, you can find these data in `data` directory.
4. **Data Storage**:
