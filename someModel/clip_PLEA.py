...
class MultiDomainPLEFENDModel(torch.nn.Module):
    ...
    def forward(self, **kwargs):
        ...
        fusion_atn_feature = torch.sum(fusion_feature * weights, dim=1)
...
##continue
        ...
        return cc_irrelevant_token,final_label_pred_list,fusion_label_pred_list,image_label_pred_list,text_label_pred_list
    ...
    def train(self):
        ...
        for epoch in range(self.epoches):
            ...
            for step_n, batch in enumerate(train_data_iter):
                ...
                cc,final_label_pred_list,fusion_label_pred_list,image_label_pred_list,text_label_pred_list = self.model(**batch_data)
                ...
                loss = loss0+0.15*loss1+0.15*loss2+0.15*loss3+0.1*loss_cc
                optimizer.zero_grad()
                loss.backward()
                optimizer.step()
    ...
    def test(self, dataloader):
        ...
        for step_n, batch in enumerate(data_iter):
            with torch.no_grad():
                ...
                _,final_label_pred_list,fusion_label_pred_list,image_label_pred_list,text_label_pred_list= self.model(**batch_data)
